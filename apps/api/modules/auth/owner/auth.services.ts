...
const REFRESH_SECRET =
  process.env.REFRESH_SECRET || "jwt_refresh_secret_default";

export const signUpService = async (data: OwnerUserData) => {
  const { barberShopName, cpf, cnpj, phoneNumber, email, password, slug } =
    data;
  ...
  if (!/[A-Z]/.test(password))
    throw new ValidationError("Senha sem letra maiúscula");
